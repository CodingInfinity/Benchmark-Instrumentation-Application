...
class JobSpecificationMessage : public virtual ::apache::thrift::TBase {
 public:
...
class ResultMessage : public virtual ::apache::thrift::TBase {
 public:
...
class Measurement : public virtual ::apache::thrift::TBase {
 public:
